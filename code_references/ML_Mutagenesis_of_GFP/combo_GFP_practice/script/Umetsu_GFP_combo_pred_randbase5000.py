...
actions = policy.bayes_search(training=training, max_num_probes=1, num_search_each_probe=npred, simulator=None, score='TS', interval=0, num_rand_basis = 5000) # 5000
