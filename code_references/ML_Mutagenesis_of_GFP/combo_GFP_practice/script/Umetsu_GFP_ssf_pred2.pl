...
# pred2: YFP (GAYF) is excluded from training data.

# usage:
# ./this_program Umetsu_GFP.csv ssf seqlen > Umetsu_GFP_ssf_pred.csv
# ./this_program Umetsu_GFP.csv VHSE psf ssf seqlen > Umetsu_GFP_VHSE_psf_ssf_pred.csv
...
while (my $line=<IN>) {
    ...
    $cells[$hidx{"Sequence"}] eq "GAYF" and next;
