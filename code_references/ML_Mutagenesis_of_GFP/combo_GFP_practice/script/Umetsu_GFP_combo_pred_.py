...
actions, ff = policy.bayes_search(training=training, max_num_probes=1, num_search_each_probe=npred, simulator=None, score='TS', interval=0, num_rand_basis = 0) # 5000
# Note by saito:
...
print "score:"
for i in xrange(len(ff[0])):
    print str(i) + "\t" + str(ff[0][i])
print "end"
